...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- 
        To run:
            ...
            cut -f 1 ../processing/conversion_scripts/dblinks.txt | sed -e 's/^/"/' | sed -e 's/$/"/' | sort | uniq | grep -rFlf - * | sort -R | xargs -P 3 -I {} java -Xmx1G -cp ../processing/saxon/saxon9he.jar net.sf.saxon.Transform -s:"{}" -xsl:../processing/conversion_scripts/add-dblinks.xsl -o:"{}"
    -->
